...
public class GCDCalculator {
  /**
   * Calculates the greatest common divisor using recursion and the euclidean algorithm
   *
   * @param a - a number
   * @param b - a number
  ...
  /**
   * This is used to test the input and output of the GCD method using pre-computed values and
